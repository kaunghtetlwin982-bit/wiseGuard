...
const createUserLogic = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const saltRounds = 10;
        const hashedPassword = yield bcrypt.hash(payload.password, saltRounds);
        // Create user with hashed password
        const userPayload = Object.assign(Object.assign({}, payload), { password: hashedPassword });
        const user = yield (0, repository_1.createUser)(userPayload);
        if (!user) {
...
const updateUserLogic = (userId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (payload.password) {
            const saltRounds = 10;
            updatePayload.password = yield bcrypt.hash(payload.password, saltRounds);
        }
        const user = yield (0, repository_1.updateUser)(userId, updatePayload);
        if (!user) {
